...
function TaskRow({
  ...
  const isRunning = !["idle", "stopped", "failed", "success", "paused_captcha"].includes(effectiveStatus);
  const canStart = ["idle", "stopped", "failed", "paused_captcha"].includes(effectiveStatus);
