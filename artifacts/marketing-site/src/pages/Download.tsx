...
const OPTIONS: { os: "win" | "mac" | "linux"; label: string; sub: string }[] = [
...
export default function Download() {
  ...
  async function startDownload(os: "win" | "mac" | "linux") {
    setError(null);
    ...
    setLoading(os);
    try {
      const { url } = await licenseApi.installerDownload(session, os);
